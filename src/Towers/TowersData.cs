...
namespace TowerDefenseMC.Towers
{
    public class TowersData
    {
        ...
        private readonly PackedScene _redTower = ResourceLoader.Load<PackedScene>("res://scenes/towers/RedTowerA.tscn");
        private readonly PackedScene _purpleTower = ResourceLoader.Load<PackedScene>("res://scenes/towers/PurpleTowerA.tscn");
